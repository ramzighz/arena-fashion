export const PRODUCTS = [
  // ===== JEANS =====
  {
    ...
    nameFr: 'JEAN SLIM TAPER INDIGO FONCÉ',
    category: 'jeans',
  ...
  },
  {
    ...
    nameFr: 'JEAN DROIT SELVEDGE BRUT',
    category: 'jeans',
  ...
  },
  {
    ...
    nameFr: 'JEAN BAGGY CARPENTER LAVÉ VINTAGE',
    category: 'jeans',
  ...
  // ===== T-SHIRTS =====
  {
    ...
    nameFr: 'T-SHIRT LOGO POIDS LOURD NOIR',
    category: 'tees',
  ...
  },
  {
    ...
    nameFr: 'T-SHIRT CREW PREMIUM BLANC',
    category: 'tees',
  ...
  // ===== POLO SHIRTS =====
  {
    ...
    nameFr: 'POLO CLASSIQUE BLEU MARINE',
    category: 'polos',
  ...
  },
  {
    ...
    nameFr: 'POLO PERFORMANCE VERT FORÊT',
    category: 'polos',
  ...
  // ===== SHIRTS =====
  {
    ...
    nameFr: 'CHEMISE FLANELLE À CARREAUX',
    category: 'shirts',
  ...
  },
  {
    ...
    nameFr: 'CHEMISE OXFORD SMART BLANCHE',
    category: 'shirts',
  ...
  // ===== LAYERING (Hoodies, Sweatshirts, Sweaters) =====
  {
    ...
    nameFr: 'HOODIE REVERSE WEAVE GRIS',
    category: 'layering',
    subcategory: 'Hoodies',
    price: 6200,
  ...
  },
  {
    ...
    nameFr: 'SWEAT CREWNECK MOYEN BRUN',
    category: 'layering',
  ...
  },
  {
    ...
    nameFr: 'CHANDAIL MAILLE CÂBLE AVOINE',
    category: 'layering',
  ...
  // ===== JACKETS =====
  {
    ...
    nameFr: 'VESTE TRUCKER DENIM LAVÉ BLEU',
    category: 'jackets',
  ...
  },
  {
    ...
    nameFr: 'VESTE BOMBER MA-1 SAUGE',
    category: 'jackets',
  ...
  // ===== BOTTOMS =====
  {
    ...
    nameFr: 'PANTALON CARGO UTILITY KAKI',
    category: 'bottoms',
  ...
  },
  {
    ...
    nameFr: 'JOGGER TECH FLEECE CHARBON',
    category: 'bottoms',
    subcategory: 'Joggers',
    price: 6500,
    fit: 'Slim Tapered',
  ...
  // ===== FOOTWEAR =====
  {
    ...
    nameFr: 'AIR MAX 90 TRIPLE BLANC',
    category: 'footwear',
  ...
  },
  {
    ...
    nameFr: 'GEL-KAYANO 14 CRÈME NOIR',
    category: 'footwear',
    subcategory: 'Sneakers',
    price: 13200,
    fit: 'True to Size',
  ...
  // ===== ACCESSORIES =====
  {
    ...
    nameFr: 'CASQUETTE SNAPBACK NOIRE',
  ...
  },
  {
    ...
    nameFr: 'CEINTURE CUIR BRUN FONCÉ',
    category: 'accessories',
    subcategory: 'Belts',
    price: 3900,
  ...
  },
  {
    ...
    nameFr: 'SAC FOURRE-TOUT TOILE MARRON',
    category: 'accessories',
    subcategory: 'Bags',
    price: 5200,
    fit: 'One Size',
  ...
  // ===== OVERSIZED TEES =====
  {
    ...
    nameFr: 'T-SHIRT OVERSIZE GRAPHIQUE NOIR',
  ...
  },
  {
    ...
    nameFr: 'T-SHIRT OVERSIZE TEXTE AUDACIEUX BLANC',
    category: 'oversized-tees',
    subcategory: 'Oversized Tees',
    price: 3200,
    fit: 'Oversized Drop Shoulder',
  ...
  // ===== ULTRA BAGGY JEANS =====
  {
    ...
    nameFr: 'JEAN ULTRA BAGGY DOUBLE GENOU NOIR',
  ...
  },
  {
    ...
    nameFr: 'JEAN ULTRA BAGGY LAVÉ VINTAGE BLEU',
    category: 'ultra-baggy',
    subcategory: 'Ultra Baggy',
    price: 9500,
    fit: 'Ultra Relaxed / Extra Wide Leg',
  ...
  // ===== HOODIES OVERSIZE =====
  {
    ...
    nameFr: 'HOODIE OVERSIZE LOGO CHARBON',
    category: 'layering',
    subcategory: 'Hoodies',
    price: 6800,
    fit: 'Oversized / Drop Shoulder',
  ...
  },
  {
    ...
    nameFr: 'HOODIE OVERSIZE MOT-LOGO NOIR',
    category: 'layering',
    subcategory: 'Hoodies',
    price: 7200,
    fit: 'Oversized / Drop Shoulder',
  ...
  // ===== JOGGERS =====
  {
    ...
    nameFr: 'JOGGER TECH FLEECE NOIR',
    category: 'bottoms',
    subcategory: 'Joggers',
    price: 5800,
    fit: 'Tapered Slim',
  ...
  },
  {
    ...
    nameFr: 'JOGGER ÉLASTIQUE TAILLE GRIS',
    category: 'bottoms',
    subcategory: 'Joggers',
    price: 4500,
    fit: 'Relaxed Tapered',
  ...
  // ===== JERSEYS =====
  {
    ...
    nameFr: 'MAILLOT FOOTBALL AMÉRICAIN BLEU MARINE',
    category: 'jerseys',
    subcategory: 'Jersey',
    price: 4800,
    fit: 'Oversized',
  ...
  // ===== OLD MONEY SHIRTS =====
  {
    ...
    nameFr: 'CHEMISE OLD MONEY À RAYURES BLEUE',
    category: 'old-money',
  ...
  },
  {
    ...
    nameFr: 'JEAN DROIT BOYFRIEND CLAIR',
    category: 'pantalon',
    subcategory: 'Pantalon',
    price: 7800,
    fit: 'Relaxed Straight',
  ...
  },
  {
    ...
    nameFr: 'SHORT JOGGER FRENCH TERRY NOIR',
    category: 'shorts',
    subcategory: 'Short',
    price: 3500,
    fit: 'Relaxed',
  ...
  // ===== SWEATSHIRTS =====
  {
    ...
    nameFr: 'SWEATSHIRT LOGO À CARREAUX NOIR BLANC',
  ...
  // ===== ENSEMBLE (SETS) =====
  {
    ...
    nameFr: 'ENSEMBLE MANCHE COURTE NOIR',
    category: 'ensemble',
